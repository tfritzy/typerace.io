...
{
    public static class JosephRoth
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://de.wikiquote.org/wiki/Joseph_Roth", Text = "Das Antlitzt der Zeit ist zernichtet. Das Leben ist zerlebt. Häßlich ist sie, die Zeit. Aber wahr. Sie läßt sich nicht malen, sondern photographieren. Ob sie wahr ist weil sie häßlich ist? Oder häßlich, weil wahr?", Author = "Joseph Roth" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Joseph_Roth", Text = "Der Begriff »Fortschritt« allein setzt bereits die Horizontale voraus. Er bedeutet ein Weiterkommen und kein Höherkommen.", Author = "Joseph Roth" },
