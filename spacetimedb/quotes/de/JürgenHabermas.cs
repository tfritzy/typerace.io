...
{
    public static class JürgenHabermas
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://de.wikiquote.org/wiki/Jürgen_Habermas", Text = "Der einzige Patriotismus, der uns dem Westen nicht entfremdet, ist ein Verfassungspatriotismus.", Author = "Jürgen Habermas" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Jürgen_Habermas", Text = "Die Antworten der Legitimisten und Neokonservativen bewegen sich im Medium eines Zeitgeist, der nur noch defensiv ist; sie drücken ein Geschichtsbewusstsein aus, das seiner utopischen Dimension beraubt ist.", Author = "Jürgen Habermas" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Jürgen_Habermas", Text = "Die Neokonservativen suchen die Krisenursachen nicht in der Funktionsweise der Ökonomie und des Staatsapparates, sondern in kulturell bedingten Legitimationsproblemen, überhaupt in dem gestörten Verhältnis von Demokratie und Kultur.", Author = "Jürgen Habermas" },
