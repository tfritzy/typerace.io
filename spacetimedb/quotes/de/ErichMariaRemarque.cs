...
{
    public static class ErichMariaRemarque
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://de.wikiquote.org/wiki/Erich_Maria_Remarque", Text = "In schwierigen Zeiten hat Gott immer eine Chance.", Author = "Erich Maria Remarque" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Erich_Maria_Remarque", Text = "Zynismus ist Herz mit negativem Vorzeichen.", Author = "Erich Maria Remarque" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Erich_Maria_Remarque", Text = "Ich dachte immer, jeder Mensch sei gegen den Krieg, bis ich herausfand, dass es welche gibt, die dafür sind, besonders die, die nicht hineingehen müssen.", Author = "Erich Maria Remarque" },
        };
    }
}