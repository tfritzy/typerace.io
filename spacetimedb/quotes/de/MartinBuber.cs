...
{
    public static class MartinBuber
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://de.wikiquote.org/wiki/Martin_Buber", Text = "Alle Reisen haben eine heimliche Bestimmung, die der Reisende nicht ahnt.", Author = "Martin Buber" },
