...
{
    public static class HugovonHofmannsthal
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Und in dem „Wie” da liegt der ganze Unterschied.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Das ganze Leben ist ein ewiges Wiederanfangen.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Die Liebe schneidet ins lebendige Fleisch.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "In jedem Anfang liegt die Ewigkeit.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Aufmerksamkeit und Liebe bedingen einander wechselseitig.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Das Schöne, auch in der Kunst, ist ohne Scham nicht denkbar.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Der gute Geschmack ist die Fähigkeit, fortwährend der Übertreibung entgegenzuwirken.", Author = "Hugo von Hofmannsthal" },
            ...
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Man hat etwas weniger Freunde, als man annimmt, aber etwas mehr, als man kennt.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Man muß der Natur darin nachstreben, daß sie keine Zwischenglieder, keine Nebensachen, kein Provisorium kennt, sondern jedes Ding als Hauptsache behandelt.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Man muß im Ganzen an jemanden glauben, um ihm im Einzelnen wahrhaft Zutrauen zu schenken.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Was Geist ist, erfaßt nur der Bedrängte.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Wenn ein Mensch dahin ist, nimmt er ein Geheimnis mit sich: wie es ihm, gerade ihm - im geistigen Sinn zu leben möglich gewesen sei.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Wer im Verkehr mit Menschen die Manieren einhält, lebt von seinen Zinsen, wer sich über sie hinwegsetzt, greift sein Kapital an.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Dies ist die Lehre des Lebens, die // erste und letzte und tiefste, // Daß es uns löset vom Bann, den die // Begriffe geknüpft.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Das Salzburger Land ist das Herz vom Herzen Europas. [...] Das mittlere Europa hat keinen schöneren Raum, und hier mußte Mozart geboren werden.", Author = "Hugo von Hofmannsthal" },
            new Quote { Id = "https://de.wikiquote.org/wiki/Hugo_von_Hofmannsthal", Text = "Die Welt ist dumm, gemein und schlecht // Und geht Gewalt allzeit vor Recht, // Ist einer redlich treu und klug, // Ihn meistern Arglist und Betrug.", Author = "Hugo von Hofmannsthal" },
