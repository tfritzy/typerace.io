...
{
    public static class DouglasAdams
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "Let us think the unthinkable, let us do the undoable, let us prepare to grapple with the ineffable itself, and see if we may not eff it after all.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "It's nice to think that one could, even here and now, be whisked away just by hitchhiking.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "The fact that we live at the bottom of a deep gravity well, on the surface of a gas covered planet going around a nuclear fireball 90 million miles away and think this to be normal is obviously some indication of how skewed our perspective tends to be.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "We don't have to save the world. The world is big enough to look after itself. What we have to be concerned about is whether or not the world we live in will be capable of sustaining us in it.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "A learning experience is one of those things that say, \"You know that thing you just did? Don't do that.\"", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "If you try and take a cat apart to see how it works, the first thing you have on your hands is a nonworking cat.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "You are disoriented. Blackness swims toward you like a school of eels who have just seen something that eels like a lot.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "Driving a Porsche in London is like bringing a Ming vase to a football game.", Author = "Douglas Adams" },
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "I think a nerd is a person who uses the telephone to talk to other people about telephones. And a computer nerd therefore is somebody who uses a computer in order to use a computer.", Author = "Douglas Adams" },
            ...
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "Thor was the God of Thunder and, frankly, acted like it.", Author = "Douglas Adams" },
            ...
            new Quote { Id = "https://en.wikiquote.org/wiki/Douglas_Adams", Text = "We are stuck with technology when what we really want is just stuff that works.", Author = "Douglas Adams" },
