...
{
    public static class MelihCevdetAnday
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://tr.wikiquote.org/wiki/Melih_Cevdet_Anday", Text = "Uyuduk mu eşit oluruz. Ne tutku, ne gurur, ne umut...", Author = "Melih Cevdet Anday" },
            new Quote { Id = "https://tr.wikiquote.org/wiki/Melih_Cevdet_Anday", Text = "Kendimi üzmek, yiyip bitirmek için çabalıyorum; hiçbir şey bulamazsam geçmişi kurcalıyorum.", Author = "Melih Cevdet Anday" },
            new Quote { Id = "https://tr.wikiquote.org/wiki/Melih_Cevdet_Anday", Text = "Şairlerin duygulu insanlar olması şart değil. Olabilir de olmayabilir de. Ama şairler düşünceli insanlardır.", Author = "Melih Cevdet Anday" },
            new Quote { Id = "https://tr.wikiquote.org/wiki/Melih_Cevdet_Anday", Text = "Garip şiiri bir temizlik şiiridir, şiirimizi sululuktan, yalancılıktan, yapmacılıktan kurtarmıştır.", Author = "Melih Cevdet Anday" },
