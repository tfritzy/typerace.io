...
public static partial class PortugueseQuotes
{
    public static class JoséRégio
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://pt.wikiquote.org/wiki/José_Régio", Text = "A minha vida é um vendaval que se soltou, É uma onda que se alevantou, É um átomo a mais que se animou... Não sei por onde vou, Não sei para onde vou Sei que não vou por aí!", Author = "José Régio" },
        };
    }
}