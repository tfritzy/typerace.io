...
{
    public static class JoséLezamaLima
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://es.wikiquote.org/wiki/José_Lezama_Lima", Text = "El verdadero rey forma la estatua del humo para colocarla en el recodo más frío de la perfección.", Author = "José Lezama Lima" },
