...
{
    public static class CarlosFuentes
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://es.wikiquote.org/wiki/Carlos_Fuentes", Text = "El verdadero artista no refleja la realidad: añade algo nuevo a la realidad.", Author = "Carlos Fuentes" },
            new Quote { Id = "https://es.wikiquote.org/wiki/Carlos_Fuentes", Text = "Fuimos fundados por la utopía; la utopía es nuestro destino.", Author = "Carlos Fuentes" },
