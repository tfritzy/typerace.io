...
{
    public static class RamónMaríadelValleInclán
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://es.wikiquote.org/wiki/Ramón_María_del_Valle-Inclán", Text = "Yo hallé siempre más bella la majestad caída que sentada en el trono.", Author = "Ramón María del Valle-Inclán" },
        };
    }
}