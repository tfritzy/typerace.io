...
public static partial class SpanishQuotes
{
    public static class EmiliaPardoBazán
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://es.wikiquote.org/wiki/Emilia_Pardo_Bazán", Text = "La paternidad, en medio de sus calvarios, proporciona goces generosos que no comprendemos los que vivimos acorazados en nuestra prudente abstención.", Author = "Emilia Pardo Bazán" },
