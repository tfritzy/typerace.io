...
{
    public static class CamilloBensodiCavour
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://it.wikiquote.org/wiki/Camillo_Benso_di_Cavour", Text = "La miglior difesa è l'attacco.", Author = "Camillo Benso di Cavour" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Camillo_Benso_di_Cavour", Text = "La monarchia costituzionale è la forma di governo che assicura il più alto grado di libertà e prosperità.", Author = "Camillo Benso di Cavour" },
            ...
            new Quote { Id = "https://it.wikiquote.org/wiki/Camillo_Benso_di_Cavour", Text = "Il progresso è inevitabile, ma può essere guidato.", Author = "Camillo Benso di Cavour" },
        };
    }
}