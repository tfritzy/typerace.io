...
{
    public static class CarloCollodi
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "Si può correggere l'orgoglio, le bizze, la gola, la pigrizia; ma la conversione di un cuore invidioso e cattivo è una specie di miracolo.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "Tutto ci par bello nella persona amata, anche i difetti: tutto ci par grazioso, anche le sguaiataggini.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "A ogni modo, tieni sempre a mente che un benefizio fatto non è mai perduto.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "Se per caso qualche povero diavolo ricorre a te per essere aiutato, tu aiutalo: né badare com'è vestito, né se abbia viso di persona da poterti rendere, un giorno o l'altro, il piacere che gli fai.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "Sulle opere buone e generose non si mercanteggia mai: né bisogna farle coll'intenzione di ripigliarci sopra il frutto e l'usura.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "La miseria, quando è miseria davvero, la intendono tutti: anche i ragazzi.", Author = "Carlo Collodi" },
            new Quote { Id = "https://it.wikiquote.org/wiki/Carlo_Collodi", Text = "Non ti fidare, ragazzo mio, di quelli che promettono di farti ricco dalla mattina alla sera. Per il solito, o sono matti o imbroglioni!", Author = "Carlo Collodi" },
