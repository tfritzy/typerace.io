...
{
    public static class 石川啄木
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            new Quote { Id = "https://ja.wikiquote.org/wiki/石川啄木", Text = "何となく、今年はよい事あるごとし。元日の朝、晴れて風無し。", Author = "石川啄木" },
            new Quote { Id = "https://ja.wikiquote.org/wiki/石川啄木", Text = "東海の小島の磯の白砂にわれ泣きぬれて蟹とたはむる", Author = "石川啄木" },
            new Quote { Id = "https://ja.wikiquote.org/wiki/石川啄木", Text = "ふるさとの訛なつかし停車場の人ごみの中にそを聴きにゆく", Author = "石川啄木" },
