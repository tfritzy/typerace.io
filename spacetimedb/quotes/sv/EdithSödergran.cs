...
{
    public static class EdithSödergran
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://sv.wikiquote.org/wiki/Edith_Södergran", Text = "Mitt liv var en het villa. Men ett har jag funnit och ett har jag verkligen vunnit - vägen till landet som icke är.", Author = "Edith Södergran" },
            new Quote { Id = "https://sv.wikiquote.org/wiki/Edith_Södergran", Text = "I landet som icke är där går min älskade med gnistrande krona.", Author = "Edith Södergran" },
            new Quote { Id = "https://sv.wikiquote.org/wiki/Edith_Södergran", Text = "Och ett människobarn är ingenting annat än visshet, och det sträcker ut sina armar högre än alla himlar.", Author = "Edith Södergran" },
            new Quote { Id = "https://sv.wikiquote.org/wiki/Edith_Södergran", Text = "Och det kommer ett svar: Jag är den som du älskar och alltid skall älska.", Author = "Edith Södergran" },
        };
    }
}