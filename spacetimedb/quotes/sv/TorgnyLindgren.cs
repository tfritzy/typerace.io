...
{
    public static class TorgnyLindgren
    {
        public static readonly Quote[] Quotes = new Quote[]
        {
            ...
            new Quote { Id = "https://sv.wikiquote.org/wiki/Torgny_Lindgren", Text = "Orden bära icke bojor, sade han. Orden, dem hava stormvindens kraft.", Author = "Torgny Lindgren" },
        };
    }
}