...
const reducersSchema = __reducers(
  __reducerSchema("archive_old_games", ArchiveOldGamesReducer),
  __reducerSchema("cleanup_old_xp_gains", CleanupOldXpGainsReducer),
  __reducerSchema("fill_game_with_bots", FillGameWithBotsReducer),
  ...
  __reducerSchema("update_bot_progress", UpdateBotProgressReducer),
