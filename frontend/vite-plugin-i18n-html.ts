...
const languagePages: LanguagePage[] = [
    ...
    { slug: "ro", htmlLang: "ro", title: "TypeRace.io | Curse rapide de tastare și monitorizare WPM", description: "Concurează cu jucători din întreaga lume în competiții de tastare în timp real. Îmbunătățește-ți viteza de tastare.", keywords: "joc de tastare, test de tastare, viteză de tastare, tastare multiplayer, cursă de tastare, test de viteză, cuvinte pe minut", nativeName: "Română", language: "Romanian", flag: "🇷🇴", noscriptHeading: "TypeRace.io | Curse rapide de tastare și monitorizare WPM", noscriptContent: "Participă la curse de tastare multiplayer în timp real. Exersează-ți viteza în meciuri publice, camere private sau modul de antrenament, folosind cuvinte și citate în limba română.", jsonLdDescription: "Joc competitiv de tastare multiplayer în care jucătorii participă la curse de tastare în timp real", tagline: "Curse de tastare multiplayer" },
    { slug: "id", htmlLang: "id", title: "TypeRace.io | Balapan Mengetik Cepat dan Pelacak WPM", description: "Berlomba melawan pemain dari seluruh dunia dalam kompetisi mengetik waktu nyata. Tingkatkan kecepatan mengetik Anda.", keywords: "permainan mengetik, tes mengetik, kecepatan mengetik, mengetik multipemain, balapan mengetik, tes kecepatan, kata per menit", nativeName: "Bahasa Indonesia", language: "Indonesian", flag: "🇮🇩", noscriptHeading: "TypeRace.io | Balapan Mengetik Cepat dan Pelacak WPM", noscriptContent: "Ikuti balapan mengetik multipemain waktu nyata. Latih kecepatan Anda dalam pertandingan publik, ruang pribadi, atau mode latihan dengan kata dan kutipan bahasa Indonesia.", jsonLdDescription: "Permainan mengetik multipemain kompetitif dengan balapan mengetik waktu nyata", tagline: "Balapan mengetik multipemain" },
    { slug: "pl", htmlLang: "pl", title: "TypeRace.io | Szybkie wyścigi pisania i pomiar WPM", description: "Ścigaj się z graczami z całego świata w zawodach pisania na żywo. Poprawiaj szybkość pisania.", keywords: "gra w pisanie, test pisania, szybkość pisania, pisanie wieloosobowe, wyścig pisania, test szybkości, słowa na minutę", nativeName: "Polski", language: "Polish", flag: "🇵🇱", noscriptHeading: "TypeRace.io | Szybkie wyścigi pisania i pomiar WPM", noscriptContent: "Bierz udział w wieloosobowych wyścigach pisania na żywo. Ćwicz szybkość w meczach publicznych, prywatnych pokojach lub trybie treningowym, używając polskich słów i cytatów.", jsonLdDescription: "Wieloosobowa gra rywalizacyjna, w której gracze ścigają się w pisaniu na żywo", tagline: "Wieloosobowe wyścigi pisania" },
    { slug: "cs", htmlLang: "cs", title: "TypeRace.io | Rychlé závody v psaní a měření WPM", description: "Závoděte s hráči z celého světa v psaní v reálném čase. Zlepšujte svou rychlost a přesnost psaní.", keywords: "hra na psaní, test psaní, rychlost psaní, psaní pro více hráčů, závod v psaní, trénink psaní, slov za minutu", nativeName: "Čeština", language: "Czech", flag: "🇨🇿", noscriptHeading: "TypeRace.io | Rychlé závody v psaní a měření WPM", noscriptContent: "Zúčastněte se závodů v psaní pro více hráčů v reálném čase. Procvičujte rychlost psaní ve veřejných zápasech, soukromých lobby nebo tréninkovém režimu pomocí náhodných českých slov a citátů.", jsonLdDescription: "Soutěžní hra v psaní pro více hráčů, ve které hráči závodí v reálném čase", tagline: "Závody v psaní pro více hráčů" },
