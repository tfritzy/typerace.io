...
const languagePages: LanguagePage[] = [
    ...
    { slug: "ja", htmlLang: "ja", title: "TypeRace.io | ハイペースなタイピングバトルとWPMトラッカー", description: "世界中のプレイヤーとリアルタイムのタイピング競争で対戦しましょう。タイピング速度を向上させましょう。", keywords: "タイピングゲーム, タイピング練習, タイピング速度, タイピングテスト, タイピングレース, 早打ち, タイピング対戦", nativeName: "日本語", language: "Japanese", flag: "🇯🇵", noscriptHeading: "TypeRace.io | ハイペースなタイピングバトルとWPMトラッカー", noscriptContent: "リアルタイムのマルチプレイヤータイピングレースに参加しましょう。英語、スペイン語、フランス語、ドイツ語、イタリア語、ポルトガル語、日本語、韓国語、中国語、ウクライナ語、アラビア語、ヒンディー語、オランダ語、スウェーデン語、トルコ語など、複数の言語から選べます。パブリックマッチ、プライベートロビー、練習モードでタイピング速度を鍛えましょう。", jsonLdDescription: "プレイヤーがリアルタイムのタイピング競争で対戦するマルチプレイヤー対戦タイピングゲーム", tagline: "マルチプレイヤータイピングレース" },
    { slug: "ko", htmlLang: "ko", title: "TypeRace.io | 빠른 템포의 타이핑 배틀과 WPM 추적기", description: "전 세계 플레이어와 실시간 타이핑 대회에서 경쟁하세요. 타이핑 속도를 향상시키세요.", keywords: "타이핑 게임, 타자 연습, 타이핑 속도, 타이핑 테스트, 타자 시합, 타자 속도 측정, 분당 타수", nativeName: "한국어", language: "Korean", flag: "🇰🇷", noscriptHeading: "TypeRace.io | 빠른 템포의 타이핑 배틀과 WPM 추적기", noscriptContent: "실시간 멀티플레이어 타이핑 레이스에 참여하세요. 영어, 스페인어, 프랑스어, 독일어, 이탈리아어, 포르투갈어, 일본어, 한국어, 중국어, 우크라이나어, 아랍어, 힌디어, 네덜란드어, 스웨덴어, 터키어 등 다양한 언어를 선택할 수 있습니다. 공개 매치, 비공개 로비, 연습 모드에서 타이핑 속도를 연습하세요.", jsonLdDescription: "플레이어가 실시간 타이핑 대회에서 경쟁하는 멀티플레이어 경쟁 타이핑 게임", tagline: "멀티플레이어 타이핑 레이스" },
    { slug: "zh", htmlLang: "zh", title: "TypeRace.io | 快节奏打字对战与 WPM 追踪器", description: "与全球玩家进行实时打字比赛。提高你的打字速度。", keywords: "打字游戏, 打字测试, 打字速度, 多人打字, 打字比赛, 打字练习, 每分钟字数", nativeName: "中文", language: "Chinese", flag: "🇨🇳", noscriptHeading: "TypeRace.io | 快节奏打字对战与 WPM 追踪器", noscriptContent: "参加实时多人打字竞赛。可选择多种语言，包括英语、西班牙语、法语、德语、意大利语、葡萄牙语、日语、韩语、中文、乌克兰语、阿拉伯语、印地语、荷兰语、瑞典语和土耳其语。在公开比赛、私人房间或练习模式中练习打字速度。", jsonLdDescription: "多人竞技打字游戏，玩家在实时打字比赛中相互竞争", tagline: "多人在线打字竞赛" },
