...
export const RecentGames = ({ gameRecords }: RecentGamesProps) => {
    ...
    return (
        <div className="box box-shadow rounded-xl overflow-hidden">
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] gap-4 p-4 border-b border-white/10 text-white text-xs uppercase tracking-wider font-bold">
                <div>Game Mode</div>
            ...
            {sortedGames.map((gameRecord) => (
                <button
                    ...
                    className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] gap-4 p-4 border-b border-white/10 last:border-b-0 hover:bg-white/5 transition-colors cursor-pointer w-full text-left bg-transparent border-0"
                >
