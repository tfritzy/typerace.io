  ...
  if (!myPlayer) {
    ...
    return (
      <div
        ...
        className="flex items-center gap-4 py-2.5 motion-safe:animate-pulse"
      >
        <div className="size-11 shrink-0 rounded-full bg-muted" />

        <div className="hidden sm:flex min-w-50 flex-col gap-1.5">
      ...
      <div className="relative" ref={menuRef}>
        ...
        {showMenu && (
          <div className="absolute top-full right-0 bg-popover border border-border rounded-md shadow-lg overflow-hidden z-50 w-56 mt-1">
            ...
            >
              <svg
                className="w-4 h-4 fill-secondary-foreground"
                viewBox="0 0 24 24"
              >
