...
export function LanguageDropdown() {
    ...
    return (
        <div className="relative inline-flex" ref={dropdownRef}>
            ...
            <div
                className={`absolute bottom-full left-0 mb-1 rounded-xl border border-border bg-card p-1.5 min-w-[160px] max-h-[50vh] overflow-y-auto z-50 transition-all duration-150 ${
                    isOpen
                        ? "opacity-100 visible"
