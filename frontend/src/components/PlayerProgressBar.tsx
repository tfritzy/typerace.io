                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    {isBot && (
                                        <div className="group relative">
                                            ...
                                            <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 px-3 py-2 bg-(--color-box-bg) border border-(--color-box-border) backdrop-blur-md text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-10 shadow-lg w-64">
