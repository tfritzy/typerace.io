...
import { ChevronDown, Globe, Lock, Target, Quote, Dice5 } from "lucide-react";
    ...
    return (
        <>
            <div className="hidden md:flex items-center justify-center gap-1 flex-wrap">
                <ModeButton isSelected={contentType === "RandomWords"} onClick={() => handleContentTypeChange("RandomWords")} icon={<Dice5 size={16} />} label={t.randomWords} />
