...
export const THEMES: Record<PlayerColor['tag'], ThemeConfig> = {
    Red: {
        ...
        avatarColors: ['#58a6ff', '#3b5998', '#21262d'],
        previewColors: ['#0d1117', '#58a6ff', '#3fb950', '#f78166'],
        gradient: 'linear-gradient(to right, #388bfd, #58a6ff)',
    },
    Orange: {
        name: 'Dracula',
        mode: 'dark',
    ...
    Emerald: {
        ...
        gradient: 'linear-gradient(to right, #5d8bea, #7aa2f7)',
    },
    Teal: {
        name: 'Cobalt 2',
        mode: 'dark',
    ...
    Sky: {
        ...
        avatarColors: ['#0969da', '#1a7f37', '#cf222e'],
        previewColors: ['#ffffff', '#0969da', '#1a7f37', '#cf222e'],
    ...
    Pink: {
        ...
        colors: {
            ...
            mutedForeground: 'rgba(87, 82, 121, 0.5)',
            accent: '#907aa9',
        ...
        gradient: 'linear-gradient(to right, #7a6494, #907aa9)',
    },
    Rose: {
        name: 'Paper',
        mode: 'light',
        colors: {
            ...
            foreground: '#3b3228',
            card: '#e8e4d9',
            cardForeground: '#3b3228',
            popover: '#e8e4d9',
            popoverForeground: '#3b3228',
            primary: '#7b7063',
            primaryForeground: '#f2eee3',
            secondary: 'rgba(59, 50, 40, 0.06)',
            secondaryForeground: 'rgba(59, 50, 40, 0.8)',
            muted: 'rgba(59, 50, 40, 0.04)',
            mutedForeground: 'rgba(59, 50, 40, 0.5)',
            accent: '#7b7063',
            accentForeground: '#f2eee3',
            accentPrimary: '#7b7063',
            accentLight: '#958a7b',
            accentDark: '#655b50',
            destructive: '#a3472e',
            destructiveForeground: '#f2eee3',
            border: 'rgba(59, 50, 40, 0.12)',
            input: '#e2ddd2',
            ring: '#7b7063',
            gridLine: 'rgba(59, 50, 40, 0.06)',
            textCompleted: 'rgba(59, 50, 40, 0.2)',
            textUntyped: 'rgba(59, 50, 40, 0.4)',
            borderHover: 'rgba(59, 50, 40, 0.22)',
        },
        avatarColors: ['#7b7063', '#a3472e', '#4e7a25'],
        previewColors: ['#f2eee3', '#7b7063', '#a3472e', '#4e7a25'],
        gradient: 'linear-gradient(to right, #655b50, #7b7063)',
    },
};
