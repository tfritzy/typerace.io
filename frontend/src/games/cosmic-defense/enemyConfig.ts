...
export const FRIENDLY_CATALOG: FriendlyConfig[] = [
  ...
  { entityType: "Dart", health: 200, projectileDamage: 6, projectileType: ProjectileType.Projectile3, chargesRequired: 6, plasmaStacks: 2, chargesGranted: 0, laserDamage: 0, freezeStacks: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, beamWidth: 0, explosionRadius: 120, hitDelay: 0.33 },
  ...
  { entityType: "Hawk", health: 200, projectileDamage: 0, projectileType: ProjectileType.Projectile2, chargesRequired: 6, plasmaStacks: 4, chargesGranted: 0, laserDamage: 0, freezeStacks: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, beamWidth: 0, explosionRadius: 120, hitDelay: 0 },
