...
export const SHIP_HITBOX_MAP: Record<EntityType, ShipHitbox> = {
  ...
  Javelin: { hitWidth: 114, hitHeight: 60 },
  ...
  Behemoth: { hitWidth: 99, hitHeight: 93 },
  Dreadnought: { hitWidth: 171, hitHeight: 87 },
  Marauder: { hitWidth: 117, hitHeight: 78 },
  Eagle: { hitWidth: 84, hitHeight: 72 },
  Pike: { hitWidth: 60, hitHeight: 48 },
  Arrow: { hitWidth: 69, hitHeight: 48 },
  Juggernaut: { hitWidth: 111, hitHeight: 90 },
  ...
  Finch: { hitWidth: 63, hitHeight: 57 },
  ...
  Piston: { hitWidth: 69, hitHeight: 66 },
  Vulture: { hitWidth: 78, hitHeight: 63 },
  Orb: { hitWidth: 63, hitHeight: 63 },
  Flicker: { hitWidth: 63, hitHeight: 54 },
  Barb: { hitWidth: 75, hitHeight: 54 },
  Sliver: { hitWidth: 72, hitHeight: 51 },
  ...
  Rampart: { hitWidth: 87, hitHeight: 63 },
