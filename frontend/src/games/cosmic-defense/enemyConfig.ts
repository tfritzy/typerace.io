...
export const FRIENDLY_CATALOG: FriendlyConfig[] = [
  ...
  { entityType: "Ember",  health: 200, projectileDamage: 7,  chargesRequired: 3,  plasmaStacks: 0,  laserDamage: 0,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 4, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Physical, fireMode: FireMode.Projectile, projectileColor: 0xff7700 },
  ...
  { entityType: "Pip",    health: 150, projectileDamage: 8,  chargesRequired: 2,  plasmaStacks: 0,  laserDamage: 0,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 2, projectileSize: 3, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Physical, fireMode: FireMode.Projectile, projectileColor: 0x88bbff },
  { entityType: "Eagle",  health: 200, projectileDamage: 0,  chargesRequired: 6,  plasmaStacks: 10, laserDamage: 0,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 2, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Plasma,   fireMode: FireMode.Laser,      projectileColor: 0xff4422 },
  { entityType: "Needle", health: 200, projectileDamage: 0,  chargesRequired: 4,  plasmaStacks: 0,  laserDamage: 3,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 2, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Laser,    fireMode: FireMode.Laser,      projectileColor: 0x50e878 },
  { entityType: "Flare",  health: 300, projectileDamage: 8,  chargesRequired: 8,  plasmaStacks: 0,  laserDamage: 0,  chillDurationSeconds: 3, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 6, explosionRadius: 120, hitDelay: 0,    damageType: DamageType.Ice,      fireMode: FireMode.Projectile, projectileColor: 0x88eeff },
  { entityType: "Dart",   health: 200, projectileDamage: 0,  chargesRequired: 6,  plasmaStacks: 15, laserDamage: 0,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 5, explosionRadius: 120, hitDelay: 0.33, damageType: DamageType.Plasma,   fireMode: FireMode.Projectile, projectileColor: 0xcc44ff },
  ...
  { entityType: "Prism",  health: 150, projectileDamage: 0,  chargesRequired: 2,  plasmaStacks: 0,  laserDamage: 4,  chillDurationSeconds: 2, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 2, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Ice,      fireMode: FireMode.Laser,      projectileColor: 0x89b4fa },
  { entityType: "Hawk",   health: 200, projectileDamage: 10, chargesRequired: 6,  plasmaStacks: 0,  laserDamage: 0,  chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 6, explosionRadius: 120, hitDelay: 0,    damageType: DamageType.Physical, fireMode: FireMode.Projectile, projectileColor: 0xff5500 },
  { entityType: "Nova",   health: 180, projectileDamage: 5,  chargesRequired: 5,  plasmaStacks: 0,  laserDamage: 0,  chillDurationSeconds: 0, chainCount: 3, buffMultiplier: 0, fireCount: 1, projectileSize: 4, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Physical, fireMode: FireMode.Projectile, projectileColor: 0x99ff44 },
  { entityType: "Lance",  health: 400, projectileDamage: 0,  chargesRequired: 14, plasmaStacks: 0,  laserDamage: 30, chillDurationSeconds: 0, chainCount: 0, buffMultiplier: 0, fireCount: 1, projectileSize: 6, explosionRadius: 0,   hitDelay: 0,    damageType: DamageType.Laser,    fireMode: FireMode.Laser,      projectileColor: 0xb060e0 },
];
