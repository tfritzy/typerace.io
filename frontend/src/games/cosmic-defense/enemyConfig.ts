...
export const FRIENDLY_CATALOG: FriendlyConfig[] = [
  ...
  { entityType: "Nova", health: 220, projectileDamage: 8, projectileType: ProjectileType.Projectile2, chargesRequired: 7, plasmaStacks: 0, chargesGranted: 0, laserDamage: 0, freezeStacks: 0, chainCount: 4, buffMultiplier: 0, fireCount: 1, beamWidth: 0, explosionRadius: 0, hitDelay: 0 },
