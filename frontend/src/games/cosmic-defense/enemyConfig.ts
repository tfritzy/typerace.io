...
export const FRIENDLY_CATALOG: FriendlyConfig[] = [
  ...
  { entityType: "Dot", health: 400, firingRange: 555, projectileSpeed: 220, projectileDamage: 15, projectileType: ProjectileType.Tiny, chargesRequired: 3 },
  { entityType: "Gnat", health: 700, firingRange: 575, projectileSpeed: 240, projectileDamage: 30, projectileType: ProjectileType.Tiny, chargesRequired: 3 },
  { entityType: "Flicker", health: 1200, firingRange: 600, projectileSpeed: 260, projectileDamage: 55, projectileType: ProjectileType.Projectile2, chargesRequired: 4 },
  { entityType: "Clipper", health: 2000, firingRange: 640, projectileSpeed: 280, projectileDamage: 100, projectileType: ProjectileType.Projectile2, chargesRequired: 4 },
  { entityType: "Stinger", health: 3500, firingRange: 680, projectileSpeed: 300, projectileDamage: 200, projectileType: ProjectileType.Projectile2, chargesRequired: 5 },
  { entityType: "Crest", health: 6000, firingRange: 720, projectileSpeed: 320, projectileDamage: 375, projectileType: ProjectileType.Projectile3, chargesRequired: 5 },
  { entityType: "Osprey", health: 10000, firingRange: 780, projectileSpeed: 340, projectileDamage: 700, projectileType: ProjectileType.Projectile3, chargesRequired: 6 },
  { entityType: "Kestrel", health: 17000, firingRange: 830, projectileSpeed: 360, projectileDamage: 1300, projectileType: ProjectileType.Projectile3, chargesRequired: 6 },
  { entityType: "Vulture", health: 28000, firingRange: 880, projectileSpeed: 380, projectileDamage: 2400, projectileType: ProjectileType.Projectile4, chargesRequired: 7 },
  { entityType: "Talon", health: 45000, firingRange: 940, projectileSpeed: 400, projectileDamage: 4500, projectileType: ProjectileType.Projectile4, chargesRequired: 7 },
  { entityType: "Warden", health: 75000, firingRange: 1000, projectileSpeed: 420, projectileDamage: 8000, projectileType: ProjectileType.Projectile5, chargesRequired: 8 },
  { entityType: "Behemoth", health: 120000, firingRange: 1060, projectileSpeed: 440, projectileDamage: 15000, projectileType: ProjectileType.Projectile5, chargesRequired: 9 },
  { entityType: "Juggernaut", health: 200000, firingRange: 1120, projectileSpeed: 460, projectileDamage: 30000, projectileType: ProjectileType.Projectile6, chargesRequired: 10 },
  { entityType: "Colossus", health: 325000, firingRange: 1200, projectileSpeed: 480, projectileDamage: 55000, projectileType: ProjectileType.Projectile6, chargesRequired: 11 },
];
