  ...
  return (
    ...
    >
      ...
      >
        ...
        {bossApproaching && (
          <div className="absolute top-20 left-1/2 z-[1] -translate-x-1/2 rounded-lg border border-[#f9e2af] bg-[rgba(17,17,27,0.78)] px-5 py-3 text-center shadow-[0_0_28px_rgba(249,226,175,0.28)] pointer-events-none">
