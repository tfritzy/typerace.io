    ...
    <>
      ...
      >
        <div className="flex flex-col items-center">
          ...
          >
            <div
              className="text-[10px] uppercase tracking-[0.3em] mt-5 mb-1 text-center"
              style={{ color: "#f9e2af", opacity: 0.6 }}
            >
              Relic Acquired
            </div>
            <div
              className="text-[20px] font-bold text-center mb-1.5"
            ...
            <div
              ...
              style={{ color: "#cdd6f4", maxWidth: 240, opacity: 0.85 }}
            >
              {relic.description}
            </div>
            <button
              className="flex items-center gap-3 rounded-lg px-5 py-2 font-semibold text-[12px] transition-all"
              style={{
