...
export const SHIP_BLUEPRINTS: ShipBlueprint[] = [
  ...
  { entityType: "Flicker", cost: 250, colorPreset: ColorPreset.Preset1 },
  ...
  { entityType: "Warden", cost: 300000, colorPreset: ColorPreset.Preset1 },
  { entityType: "Behemoth", cost: 750000, colorPreset: ColorPreset.Preset1 },
  { entityType: "Juggernaut", cost: 2000000, colorPreset: ColorPreset.Preset1 },
