...
import { Crosshair, Gauge, Flame, Zap, Focus } from "lucide-react";
import type { LucideIcon } from "lucide-react";

export type ShipRole = "shooter" | "rapid_fire" | "plasma" | "charge" | "laser";
...
export const SHIP_BLUEPRINTS: ShipBlueprint[] = [
  ...
  { entityType: "Spark", colorPreset: ColorPreset.Preset1, role: "plasma", description: "Explosive projectile that burns an area" },
  { entityType: "Pulse", colorPreset: ColorPreset.Preset1, role: "charge", description: "Grants a charge to all allied ships" },
