...
export type ShipRole = "shooter" | "alternating" | "healer" | "shield" | "damage" | "charge" | "laser";
...
export const SHIP_BLUEPRINTS: ShipBlueprint[] = [
  ...
  { entityType: "Osprey", cost: 15, colorPreset: ColorPreset.Preset1, role: "alternating", description: "Rapid fire, alternating between targets" },
  ...
  { entityType: "Spark", cost: 15, colorPreset: ColorPreset.Preset1, role: "damage", description: "Boosts damage of nearby allied ships" },
