...
export const CITY_HALF_WIDTH = 18;
export const CITY_MAX_HEIGHT = 20;
export const CITY_MIN_HEIGHT = 3;
export const CITY_EMBED_DEPTH = 3;
export const CITY_MIN_BUILDINGS = 8;
export const CITY_BUILDING_COUNT_VARIANCE = 5;
