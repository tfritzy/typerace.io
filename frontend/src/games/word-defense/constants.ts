...
export const METEOR_DESTRUCTION_PARTICLE_LIFETIME_MIN = 0.45;
export const METEOR_DESTRUCTION_PARTICLE_LIFETIME_MAX = 0.95;
export const METEOR_DESTRUCTION_PARTICLE_SPEED_SCALE_MIN = 2.2;
export const METEOR_DESTRUCTION_PARTICLE_SPEED_SCALE_MAX = 5.2;
export const METEOR_DESTRUCTION_PARTICLE_SIZE_SCALE_MIN = 0.12;
export const METEOR_DESTRUCTION_PARTICLE_SIZE_SCALE_MAX = 0.34;
