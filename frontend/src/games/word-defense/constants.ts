...
export const CRATER_FLOOR_COLOR: [number, number, number] = [45, 81, 45];
export const CRATER_WALL_COLOR: [number, number, number] = [80, 144, 80];
export const CRATER_RIM_COLOR: [number, number, number] = [140, 252, 140];
export const CRATER_EJECTA_COLOR: [number, number, number] = [110, 198, 110];
...
export const CRATER_CARVE_RATIO = 0.35;
...
export const ACTIVE_WAVE_ZOOM = 0.5;
