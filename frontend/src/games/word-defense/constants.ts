...
export const INITIAL_TURRET_COUNT = 2;
...
export const BETWEEN_WAVE_ZOOM = 1.1;
export const BETWEEN_WAVE_FOCUS_Y = CANVAS_HEIGHT * 0.42;
...
export const RAILGUN_SPEED = 400;
