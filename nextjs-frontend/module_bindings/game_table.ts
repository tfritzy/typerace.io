 ...
 */
export class GameTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<Game>;

  constructor(tableCache: __TableCache<Game>) {
